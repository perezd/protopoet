...
public final class EnumSpecTest {
  ...
  public void testWritingEmptyEnumWithComment() {
   output
     ...
     .produce(() ->
              EnumSpec.builder("A")
              .setEnumComment("this is a comment")
              .build());
  }
  ...
  public void testWritingEnumWithFields() {
    output
      ...
      .produce(() ->
               ...
               .addEnumFields(EnumFieldSpec.builder("A", 1).setFieldComment("field 1"),
  ...
  public void testWritingReservations() {
    output
      ...
      .produce(() ->
               ...
               .addEnumFields(EnumFieldSpec.builder("A", 10).setFieldComment("field 1"),
  ...
  public void testWritingEnumOptions() {
    output
      ...
      .produce(() ->
               EnumSpec.builder("A")
               .setEnumComment("comment")
               .addEnumOptions(OptionSpec.builder(OptionType.ENUM, "b")
  ...
  public void testEnsureOptionTypeEnforced() {
    ...
    EnumSpec.builder("A")
      .addEnumOptions(OptionSpec.builder(OptionType.MESSAGE, "b"));
  }
}
