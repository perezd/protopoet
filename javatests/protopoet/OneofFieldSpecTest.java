...
public final class OneofFieldSpecTest {
  ...
  public void testWritingOneofFields() {
    output
      ...
      .produce(() ->
               OneofFieldSpec.builder("A")
               .setFieldComment("comment")
               .addMessageFields(MessageFieldSpec.builder(FieldType.BOOL, "b", 1),
  ...
  public void testWritingOneofOptions() {
    output
      ...
      .produce(() ->
               OneofFieldSpec.builder("A")
               .setFieldComment("comment")
               .addOneofOptions(OptionSpec.builder(OptionType.ONEOF, "b")
  ...
  public void testEnsureOptionTypeEnforced() {
    ...
    OneofFieldSpec.builder("A")
      .addOneofOptions(OptionSpec.builder(OptionType.MESSAGE, "b"));
  }
}
