...
public final class ProtoFileTest {
  ...
  public void testWritingImports() {
    output
      ...
      .produce(() ->
               ProtoFile.builder()
               .addImports(ImportSpec.of("test.proto"),
  ...
  public void testWritingEmptyNestedMessages() {
    output
      ...
      .produce(() ->
               ProtoFile.builder()
               .setFileComment("this is a test of writing multiple top-level messages",
               ...
               .addMessages(MessageSpec.builder("B")
                            .addMessages(MessageSpec.builder("C"),
                                         MessageSpec.builder("D").setMessageComment("this one has a comment")))
               .build());
  }
  ...
  public void testWritingEnums() {
    output
      ...
      .produce(() ->
               ...
               .setPackageName("com.testing")
               .addEnums(EnumSpec.builder("TopLevel")
                         .setEnumComment("This is toplevel")
                         .addReservations(ReservationSpec.builder(3, 5).setReservationComment("reserved"))
                         .addEnumFields(EnumFieldSpec.builder("A", 1),
                                        EnumFieldSpec.builder("B", 2)))
               .addMessages(MessageSpec.builder("TopLevelMsg")
                            .addEnums(EnumSpec.builder("InnerEnum")
                                      .setEnumComment("this is inside")
                                      .addReservations(ReservationSpec.builder("foo").setReservationComment("reserved"))
                                      .addEnumFields(EnumFieldSpec.builder("C", 1),
  ...
  public void testWritingExtensions() {
    output
      ...
      .produce(() ->
               ...
               .setPackageName("com.testing")
               .addExtensions(ExtensionSpec.builder(OptionType.SERVICE)
                              .setExtensionComment("comment")
                              .addExtensionFields(MessageFieldSpec.builder(FieldType.BOOL, "foo", 1),
  ...
  public void testWritingServices() {
    output
      ...
      .produce(() ->
               ...
               .setFileComment("comment")
               .setPackageName("com.testing")
               .addServices(ServiceSpec.builder("A")
                            .setServiceComment("comment")
                            .addRpcFields(RpcFieldSpec.builder("B")
                                          .setFieldComment("comment")
  ...
  public void testWritingFileOptions() {
    output
      ...
      .produce(() ->
               ProtoFile.builder()
               .setFileComment("comment")
               .addFileOptions(OptionSpec.builder(OptionType.FILE, "b")
  ...
  public void testEnsureOptionTypeEnforced() {
    ...
    ProtoFile.builder()
      .addFileOptions(OptionSpec.builder(OptionType.MESSAGE, "b"));
  }
